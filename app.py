...
/* Hide material icon text that shows as "keyboard_arrow_right" */
[data-testid="stSidebar"] [data-testid="stExpander"] span[data-testid="stMarkdownContainer"] p {
    font-size: 0.9rem !important;
}
