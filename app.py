...
def generate_unit_package(sequence_data, topic, grade_level, is_sped, is_ml, language, subject, strategy, source_text, due_date, due_time, points, points_per_question, question_types, standard="General Standard"):
...
2. CONTEXT
I am teaching a unit on "{topic}" (Subtopic: {subtopic}). Student Profile: Mixed ability. {sped_context} {ml_context}
...
2. CONTEXT
I am teaching a unit on "{topic}" (Subtopic: {subtopic}). Subject: {subject} Student Profile: Mixed ability. {sped_context} {ml_context}
...
2. CONTEXT
I am planning a comprehensive unit on "{topic}". Subject: {subject} Student Profile: Mixed ability. {sped_context} {ml_context}
        ...
        if sequence_data:
            ...
            with st.spinner("Generating Unit Resources (This may take a moment)..."):
                unit_zip = generate_unit_package(
                    sequence_data, topic, grade_level, is_sped, is_ml, language, 
