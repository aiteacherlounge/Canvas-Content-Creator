...
/* Main Content Checkbox - use direct color value */
...
if content_type == "Assignment":
    ...
    with col1:
        include_lesson_plan = st.checkbox("Lesson Plan PDF", key="lesson_plan_cb")
    with col2:
        include_slides = st.checkbox("Slides PPTX", key="slides_cb")
