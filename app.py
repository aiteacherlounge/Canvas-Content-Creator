...
/* Text area in sidebar - match other fonts */
[data-testid="stSidebar"] textarea {
    font-family: 'Open Sans', sans-serif !important;
}
...
/* Hide the material icon fallback text (keyboard_arrow_right/down) */
...
/* Hide any icon text fallback */
[data-testid="stSidebar"] [data-testid="stExpander"] span[class*="icon"],
...
/* Main Content Checkbox Labels - Match Assignment Builder color */
.main .stCheckbox {
    color: var(--brand-dark) !important;
}
...
if content_type == "Assignment":
    ...
    include_lesson_plan = st.checkbox("Download Lesson Plan PDF")
    include_slides = st.checkbox("Download Slides PPTX")
