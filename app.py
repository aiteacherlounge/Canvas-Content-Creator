...
/* ============================================
   HIDE "key" TEXT - AGGRESSIVE APPROACH
   This targets the keyboard shortcut indicator
   ============================================ */

/* Hide by content - targets elements containing "key" */
[data-testid="stSidebar"] span:not([data-testid]):not([class]) {
    display: none !important;
}

/* Hide material icons that show as text */
.material-icons, 
...
/* Target the specific keyboard shortcut element */
...
[data-testid="stSidebar"] [aria-label*="shortcut"] {
    display: none !important;
}

/* Hide any floating text in sidebar header area */
[data-testid="stSidebarHeader"] {
    display: none !important;
}

[data-testid="stSidebarUserContent"] > div:first-child > span {
    display: none !important;
}

/* Ultra aggressive - hide any raw text node appearance */
...
[data-testid="stSidebar"] > section > div:first-child [data-testid] {
    font-size: 1rem !important;
}

/* HIDE "keyboard" text specifically - the icon fallback */
...
/* Target stSidebarCollapseButton which contains the keyboard icon */
...
/* Hide the collapse icon container */
[data-testid="stSidebar"] button svg,
[data-testid="stSidebar"] button span {
    visibility: visible !important;
}

[data-testid="stSidebar"] > section > div > button,
