...
# --- Configuration ---
st.set_page_config(page_title="Canvas Content Creator", page_icon="✨", layout="wide")
...
[data-testid="stSidebar"] textarea:focus {
    ...
    box-shadow: 0 0 0 2px rgba(90, 154, 90, 0.3) !important;
}
...
# Branded Header
st.markdown('<span class="studio-badge">Canvas Content Creator</span>', unsafe_allow_html=True)
st.title("✨ Canvas Content Creator")
st.markdown("Generate Canvas-ready Assignments, Quizzes, and Full Units with AI. Use structured CRTF prompts that work with any AI system.")

# Feature Pills
st.markdown("""
<div style="margin-bottom: 1.5rem;">
    <span class="feature-pill">📝 Lesson Prompts</span>
    <span class="feature-pill">❓ Quiz Builder</span>
    <span class="feature-pill">📚 Unit Planner</span>
    <span class="feature-pill">🎨 Interactive Embeds</span>
</div>
""", unsafe_allow_html=True)
...
with st.sidebar:
    ...
    with st.expander("♿ Student Needs & Differentiation"):
        ...
        is_gifted = st.toggle("Include Gifted/Advanced Learner Extensions")
